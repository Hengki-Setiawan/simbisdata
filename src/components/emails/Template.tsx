...
export const WelcomeEmail: React.FC<Readonly<WelcomeEmailProps>> = ({
    ...
    <div style={{ fontFamily: "sans-serif", color: "#333", maxWidth: "600px", margin: "0 auto", padding: "20px", border: "1px solid #e2e8f0", borderRadius: "8px" }}>
        <h1 style={{ color: "#4f46e5", fontSize: "24px", marginBottom: "16px" }}>Selamat datang di SimbisData, {firstName}! 🚀</h1>
        <p style={{ fontSize: "16px", lineHeight: "1.5" }}>
            Terima kasih telah bergabung dengan platform analitik canggih khusus UMKM.
        </p>
        <p style={{ fontSize: "16px", lineHeight: "1.5" }}>
            Dengan SimbisData, kini kamu bisa menganalisis ribuan data penjualanmu secara kilat menggunakan Machine Learning, tanpa takut lemot!
        </p>
