...
const faqs = [
    { q: "Apa itu SimbisData?", a: "SimbisData adalah platform SaaS yang membantu UMKM Indonesia menganalisis data penjualan menggunakan Machine Learning dan AI. Upload file Excel dari marketplace manapun (Shopee, Tokopedia, Lazada, TikTok Shop) atau data penjualan sendiri, dan dapatkan insight bisnis otomatis." },
    { q: "File apa saja yang bisa diupload?", a: "SimbisData mendukung file Excel (.xlsx, .xls) dan CSV dari marketplace manapun: Shopee, Tokopedia, Lazada, TikTok Shop, Bukalapak, atau data penjualan UMKM sendiri. Sistem akan otomatis mendeteksi format dan memetakan kolom." },
    ...
    { q: "Algoritma ML apa saja yang digunakan?", a: "SimbisData menggunakan K-Means Clustering (segmentasi customer), Anomaly Detection (Z-Score), Product Performance Scoring, RFM Analysis, Time Series Forecasting, Association Rule Mining, dan lainnya." },
        ...
        <div style={{ minHeight: "100vh", padding: "80px 24px 60px" }}>
            <div style={{ maxWidth: "800px", margin: "0 auto" }}>
                <div style={{ textAlign: "center", marginBottom: "48px" }}>
                    ...
                    <p style={{ color: "var(--text-muted)", fontSize: "1rem" }}>Jawaban untuk pertanyaan umum tentang SimbisData.</p>
                </div>
