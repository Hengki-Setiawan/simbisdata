...
export const metadata: Metadata = { title: "Syarat & Ketentuan — SimbisData", description: "Syarat dan ketentuan penggunaan platform SimbisData." };
    ...
    return (
        <div style={{ minHeight: "100vh", padding: "80px 24px 60px" }}>
            <div style={{ maxWidth: "800px", margin: "0 auto" }}>
                ...
                {[
                    { title: "1. Penggunaan Layanan", content: "SimbisData menyediakan layanan analisis data penjualan UMKM berbasis web. Dengan menggunakan layanan ini, Anda menyetujui untuk mematuhi syarat dan ketentuan berikut. Layanan ini ditujukan untuk penggunaan bisnis yang sah dan tidak boleh digunakan untuk aktivitas ilegal atau melanggar hak pihak ketiga." },
                    ...
                    { title: "3. Data & Privasi", content: "Data yang Anda upload ke SimbisData hanya digunakan untuk keperluan analisis. Kami tidak menjual, membagikan, atau memanfaatkan data Anda untuk keperluan lain. Data diproses secara aman dan dihapus sesuai dengan kebijakan retensi data per tier langganan." },
                    ...
                    { title: "5. Batasan Layanan", content: "SimbisData menyediakan analisis berdasarkan data yang Anda upload. Kami tidak menjamin keakuratan prediksi atau rekomendasi AI. Hasil analisis bersifat informatif dan keputusan bisnis tetap menjadi tanggung jawab pengguna." },
                    { title: "6. Hak Kekayaan Intelektual", content: "Seluruh konten, desain, algoritma, dan teknologi di platform SimbisData dilindungi hak cipta. Anda tidak diperkenankan meng-copy, mendistribusikan, atau merekayasa balik (reverse engineer) bagian manapun dari layanan." },
